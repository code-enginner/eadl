...
@section('content')
    ...
    <div class="mt-5 w-full">
        <div class="p-5 w-full">متقاضی گرامی نتیجه استعلام شما به شرح زیر است:</div>
        <p class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam corporis dolores eos eum inventore iste
            laboriosam, molestiae perferendis praesentium similique! At consequatur dolorem et exercitationem ipsam
            labore nobis qui sunt!</p>
        <div class="mt-3">
